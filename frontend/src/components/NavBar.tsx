				...
				<Navbar fluid id="web-navbar">
					...
					<Navbar.Collapse>
						...
						<Dropdown
							...
							inline
							label={
								<p className={`border-b border-gray-100 font-barlow ${["/experience", "/showcase", "/projects"].includes(location.pathname) ? 'text-cyan-700' : 'text-slate-500'} hover:text-cyan-700 max-sm:w-full max-sm:py-2 md:border-0`}>
									Experience
								</p>
							}>
							<Dropdown.Item
						...
						<Navbar.Link
							active={location.pathname === '/blog' || location.pathname === '/blog/view'}
						...
						{!cookies.user ? (
							...
							<>
								<Navbar.Link
									...
									disabled={location.pathname === '/admin/dashboard'}
